...
env_default MONITORING_ENDPOINT_COMMAND_START ""
...
configure_env_variables() {
  ...
  local quoted_vars=(
    ...
    CHECKSUM_VALIDATION CONSOLE_LOGGING MONITORING_ENDPOINT_COMMAND_START MONITORING_ENDPOINT_COMMAND ENTRYPOINT_START JSON_LOGGING
  )
